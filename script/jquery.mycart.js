  ...
  var loadMyCartEvent = function(targetSelector){
    ...
    if(!$("#" + idCartModal).length) {
      $('body').append(
        ...
        '<h4 class="modal-title" id="myModalLabel"><span class="glyphicon glyphicon-shopping-cart"></span> ForeverCheaper</h4>' +
        '</div>' +
        ...
        '<button type="button" name="place_order" id="place_order" class="btn btn-primary ' + classCheckoutCart + '">Next</button>' +
        '</div>' +
        '</div>' +
        '</div>' +
        '</div>'
...
//           <td><input  type="button" name="place_order" id="place_order" value="Place your Order"></td>
//        <td><input type="button" name="clear_order" id="clear_order" value="Clear Order"></td>
    ...
    var drawTable = function(){
      ...
      $cartTable.append(products.length ?
        ...
        '<td></td>' +
        '</tr>'
        : '<div class="alert alert-danger" role="alert" id="' + idEmptyCartMessage + '">There is nothing in your cart. Please, buy somthing at ForeverCheaper</div>'
      );
      ...
      if(products.length && discountPrice !== null) {
        $cartTable.append(
          '<tr style="color: red">' +
          '<td></td>' +
          '<td><strong>Total:<br>This includes all benefits included for our ForeverCheaper<br>memebers!)</strong></td>' +
          '<td></td>' +
          '<td></td>' +
